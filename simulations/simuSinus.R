...
ggarrange(tx_sinus_skykappa_err[[1]], tx_sinus_skygrid_err[[1]], tx_sinus_skygrowth_err[[1]], nrow=3, ncol=1, labels=c("Skykappa","Skygrid","Skygrowth"), label.x = 0.05, label.y = 1.05, font.label=list(size=12), legend="right", common.legend = TRUE) +
	theme(plot.margin = margin(0.5,0.5,0.5,0.5, "cm"))
ggsave("error_plots/comp_models/mae/sinus_diff_samp_sizes.pdf", units="in", width=9, height=12, dpi=600)

ggarrange(tx_sinus_skykappa_err[[2]], tx_sinus_skygrid_err[[2]], tx_sinus_skygrowth_err[[2]], nrow=3, ncol=1, labels=c("Skykappa","Skygrid","Skygrowth"), label.x = 0.05, label.y = 1.05, font.label=list(size=12), legend="right", common.legend = TRUE) +
	theme(plot.margin = margin(0.5,0.5,0.5,0.5, "cm"))
